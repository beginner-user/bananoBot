...
Un plugin no se cargará hasta que se carguen sus dependencias, asi que el evento "onRoomLink" de los plugins no seran llamados hasta que sus dependecias sean llamadas, esta es la forma de establecer un orden si se quiere de las extensiones de una función.
